  ...
  welcomeButton() {
    request({
      ...
      if (!error && response.statusCode == 200) {
        ...
        if (messageId) {
          console.log("Successfully sent message with id %s", messageId);
    ...
    request({
      ...
      if (error) {
        ...
        greetings = {
          ...
          message: { text: "Hello " + name.first_name + " " + name.last_name + ", we can help you to find business in the northwest region." },
        };
      };
      callback(greetings);
    });
